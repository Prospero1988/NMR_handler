...
def print_help():
    print()
    print("This script is designed for manipulating CSV files containing NMR data sets. It provides the following functionality:")
    print()
    print("1. Adding custom headers to the data in CSV files.")
    print("2. Copying a specified column from another CSV file and adding it as the first column in the current file.")
    print()
    print("To use the script, provide the following options:")
    print()
    ...
    print()
    print("Example usage:")
    print("python header_and_column_insert.py -d /path/to/directory -c 'C' -s /path/to/second_file.csv -n 3")
    print()
    print("The script will process each CSV file in the specified directory, adding custom headers and copying the specified column from the second CSV file. The resulting files will be saved with the modifications.")
    print()
    print("Note: Make sure you have the necessary permissions to read and write files in the specified directories.")
    print()
...
# Get the file path
file_name = input("Enter filename of the CSV file: ")
print()
